    ...
    return (
        <>
            <MDBTabs className="team-info-tabs mb-3">
                <MDBTabsItem>
                    <MDBTabsLink
                        onClick={() => handleBasicClick('members')}
                        active={basicActive === 'members'}
                    >
                        Members
                    </MDBTabsLink>
                </MDBTabsItem>
                ...
                <MDBTabsItem>
                    <MDBTabsLink
                        onClick={() => handleBasicClick('ideas')}
                        active={basicActive === 'ideas'}
                    >
                        Ideas
                    </MDBTabsLink>
                </MDBTabsItem>
                <MDBTabsItem>
                    <MDBTabsLink
                        onClick={() => handleBasicClick('documents')}
                        active={basicActive === 'documents'}
                    >
                        Documents
                    </MDBTabsLink>
                </MDBTabsItem>
            ...
            <MDBTabsContent>
                <MDBTabsPane show={basicActive === 'members'}>
                    <MemberInfoTab
                        team={props.team}
                        viewInviteMember={props.viewInviteMember}
