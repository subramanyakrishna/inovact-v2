...
const SuggestionInvitation =()=>{
    return(
        <div className="suggestions">
            <h6 className="sub-title">Suggestion Invitation</h6>
               <div className="suggestions__row">
                   <div className="suggestions__row__rowInfo">
                     ...
                     <div className="suggestions__row__buttons">
                         <button className="suggestions__row__button--green">Accept</button>
                         <button className="suggestions__row__button--white">Remove</button>
                     </div>
                   </div>
               </div>
                          <div className="suggestions__row">
