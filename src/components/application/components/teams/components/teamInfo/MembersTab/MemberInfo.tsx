        ...
        history.push('/app/otherprofile')
                ...
                return(
                    <div className="members-info">
                        ...
                        {props.member.admin? ( <div className="text-color--green"  onClick={getTheOtherUser.bind(
                                            null,
                                            props.member.user.id
                                        )}>Admin</div>):( <div className="members-info__details--role">
                                  <h5 className="text-size--big">{props.member.role}</h5>
                                  {props.member.admin ? (<div className="members-info__details__dropdown">
                                        ...
                                        </div>) : (<div  onClick={getTheOtherUser.bind(
                                            null,
                                            props.member.user.id
