    ...
    return (
        <div className="top-profile-content">
            {otherUser.avatar ? (
                <div className="top-profile-user-tag">
                    ...
                    <div className="top-profile-user-data">
                        <span className="top-profile-user-data-name">
                            {props.userInfo.first_name}{' '}
                            {props.userInfo.last_name}
                        </span>
                        <span className="top-profile-user-data-designation">
                            {props.userInfo.designation}
                        </span>
                        <span className="top-profile-user-data-university">
            ...
            <div className="top-profile-post-buttons">
                {props.showAbout && (
                    <div
                        className="top-profile-post-buttons-about-btn"
                        onClick={showLeftContent}
                        style={{
                            borderBottom: props.showLeft
                                ? '3px solid #02bd63'
                                : 'none',
                            cursor: 'pointer',
                        }}
                ...
                <div
                    onClick={() => showProjectsOnly()}
                    style={{
                        borderBottom: showProjects
                            ? '3px solid #02bd63'
                            : 'none',
                        cursor: 'pointer',
                    }}
                ...
                <div
                    onClick={() => showIdeasOnly()}
                    style={{
                        borderBottom: showIdeas ? '3px solid #02bd63' : 'none',
                        cursor: 'pointer',
                    }}
                >
                    <img src={ideasImg} />
                ...
                <div
                    onClick={() => showThoughtsOnly()}
                    style={{
                        borderBottom: showThoughts
                            ? '3px solid #02bd63'
                            : 'none',
                        cursor: 'pointer',
                    }}
                ...
                <div className="top-profile-post-buttons-options">
                    ...
                    {showOptions && (
                        <div
                            className="top-profile-post-buttons-options-all"
                            onMouseLeave={() => toggleShowOptionsSlow()}
                        >
                            <span onClick={() => props.showBlockUser()}>
                                Block Account
                            </span>
                            <span onClick={() => props.showReportUser()}>
                                Report Account
                            </span>
                            <span onClick={() => props.showRestrictUser}>
                                Restrict Account
                            </span>
                        </div>
                    )}
