    ...
    const replyData = [
        {
            ...
            tag: 'JaneDoe',
            comment:
                'Project dA fermentum posuere tellus leo bibendum nibh. sed Sed commodo ',
        },
        {
            img: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80',
            name: 'Jane Doe',
            ...
            <div className="comments-on-posts-main-comment-container">
                ...
                <div className="comments-on-posts-comment-contents">
                    <div className="comments-on-posts-comment">
                        Project dA fermentum posuere tellus leo bibendum nibh.
                        sed Sed commodo sit volutpat pellentesque nisl integer
                        diam quis. A fermentum posuere tellus leo diam qui
                        bibendum nibh. Sed commodo...escription Lorem ipsum
