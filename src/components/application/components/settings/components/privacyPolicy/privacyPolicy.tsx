...
const PrivacyPolicy: React.FC = () => {
    return (
        <div className="faq">
            ...
            >
                Privacy Policy for INOVACT PRIVATE LIMITED
            </div>
            <div
                className={'text-color--black'}
                style={{ marginBottom: '5px' }}
            >
                At Inovact , accessible from www.inovact.in, one of our main
                priorities is the privacy of our visitors. This Privacy Policy
                document contains types of information that is collected and
                recorded by Inovact and how we use it. If you have additional
                ...
                collect in Inovact . This policy is not applicable to any
            ...
            <div
                ...
                style={{ marginBottom: '5px' }}
            >
                Inovact follows a standard procedure of using log files. These
            ...
            >
                ...
                the advertising partners of Inovact . Third-party ad servers or
                ad networks uses technologies like cookies, JavaScript, or Web
                Beacons that are used in their respective advertisements and
                links that appear on Inovact , which are sent directly to users'
                ...
                Note that Inovact has no access to or control over these cookies
            ...
            <div
                ...
                style={{ marginBottom: '5px' }}
            >
                Inovact 's Privacy Policy does not apply to other advertisers or
            ...
            >
                ...
                activity. Inovact does not knowingly collect any Personal
