...
function Notifications() {
    const data = [
        {
            ...
            comment: "Egestas sed sit quam mattis vitae eu egastas sed sit quam mattis sem at et.",
            time: "1hr",
    ...
    return (
        <div className="notifications-main">
            {
                data.map((noti: any)=>{
                    return <NotificationTag name={noti.name} comment={noti.comment} time={noti.time} img={noti.image}/>
                })
            }
        </div>
    )
