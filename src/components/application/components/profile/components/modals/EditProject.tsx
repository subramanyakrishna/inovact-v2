...
function EditProject(props: any) {
    ...
    const projectData = useSelector((state: any)=>state.userAllProjects.filter((project:any)=>{
        ...
        <div className="modal_main">
            <div className="modal_cover">
                ...
                <div className="modal_content">
                    ...
                    <ModalPart2 projectCompletion={toggleProjectCompletion} projectCompleted={projectCompleted} projectData={editProjectData}/>
