...
function EditBio(props: any) {
    ...
    return ( 
        <div className="edit-bio-modal">
            ...
            <textarea className="edit-bio-content" placeholder="Enter the new bio..." onChange={(e: any)=>handleUserInfoChange("bio",e.target.value)}/>
            <input type="text" className="edit-bio-website" placeholder="Enter Portfolio Website" onChange={(e)=>{
                handleUserInfoChange("website",e.target.value);
            }}/>
            <div>
                <button className="edit-bio-editbtn" onClick={updateBio}>Edit</button>
            </div>
        </div>
    )
}
