    ...
    return (
        <div className="post-dedicated-team-members-page" id="team-members">
            <div className="post-dedicated-team-members-page-top">
                <p
                    className="post-dedicated-team-members-page-title"
                    onClick={viewMembers}
                >
                    Members
                </p>
                ...
                {window.innerWidth >= 992 && props.postData.type !== 2 && (
                    <div className="post-dedicated-team-members-page-status">
                        <p>Project Status:</p>
                        <p style={{ color: '#02bd63' }}>
                            {props.postData.project_status}
                        </p>
                    </div>
                )}
            </div>
                ...
                <div>
                    {props.postData.team ? (
                        ...
                        <p>
                            ...
                            {props.postData.type === 1 ? 'project' : 'idea'}.
                        </p>
                    )}
