        ...
        <div className="modal_main">
            <div className="modal_cover">
                ...
                <div className="modal-complete-title">
                    ...
                    <label className="modal-complete-title-description">Current Team Working on Project</label>
                </div>
                    ...
                    <div className="all-team-member-cards">
                        {
                            teamMembers.map((mem: any)=>{
                                return <TeamMemberCard name={mem.name} role={mem.role} designation={mem.designation}/>
                            })
                        }
                    </div>
