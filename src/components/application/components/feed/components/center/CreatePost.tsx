    ...
    return (
        <>
            <div className="create-post">
                ...
                <div className="create-post__content">
                    ...
                    <div className="create-post__content__options">
                        <div
                            className="create-post__content__options__button"
                        ...
                        <div
                            className="create-post__content__options__button"
                            onClick={props.openIdea}
                        >
                            New Idea
                        </div>
                        <div
                            className="create-post__content__options__button"
                            onClick={props.openThought}
                        >
                            New Thought
                        </div>
                    </div>
            ...
            <div className="floating-button">
                ...
                <div
                    className="floating-button-img-container"
                    onClick={togglePopUp}
                >
                    <button className="gotop-button" onClick={goToTopFeed}>
                        <img src={arrowUp} alt="^" />
                    </button>
