...
<div className="user-info">
    ...
    <div className="role-selection__cards">
                <MDBRow>
                    ...
                    >    
                        <div    className={activeIndex === 0 ? 'role-selection__cards__item role-selection__cards__item--active': 'role-selection__cards__item'} >
                                            <img src={student} id="student" alt="student" onClick={handleChange('role')} />
                                            <h6>Student</h6>
                         </div>
                    ...
                    >
                            <div   className={activeIndex === 1 ? 'role-selection__cards__item role-selection__cards__item--active': 'role-selection__cards__item'} >
                                <img src={mentor} id="mentor" alt="mentor" onClick={handleChange('role')} />
                                <h6>Mentor</h6>
                            </div>
                    ...
                    >
                        <div   className={activeIndex === 2 ? 'role-selection__cards__item role-selection__cards__item--active': 'role-selection__cards__item'} >
                            <img src={enterprenuer} id="enterprenuer" alt="enterprenuer" onClick={handleChange('role')} />
                            <h6>Enterprenuer</h6>
                        </div>
                    </MDBCol>
                </MDBRow>
